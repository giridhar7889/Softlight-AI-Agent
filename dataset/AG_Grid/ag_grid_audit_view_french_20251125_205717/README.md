# AG Grid: Build an audit view (quick filter French, pin Language left, sort Balance high to low)

## Workflow Information

- **Task ID**: ag_grid_audit_view_french
- **App**: Linear
- **Timestamp**: 2025-11-25T20:57:17.671243
...
### Step 2: Applied global quick filter for 'French'
