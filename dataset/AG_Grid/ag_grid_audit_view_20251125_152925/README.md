# AG Grid: Build an audit view (quick filter English, pin Language left, sort Balance high to low)

## Workflow Information

- **Task ID**: ag_grid_audit_view
- **App**: Linear
- **Timestamp**: 2025-11-25T15:29:25.620707
...
- **Reasoning**: Focused the grid on rows containing the term 'English'
